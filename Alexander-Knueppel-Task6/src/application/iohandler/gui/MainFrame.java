...
public class MainFrame extends JFrame {
	...
	private JComponent makeClassifyPanel() {
		...
		String[] classifiersStr = new String[classifierAlgorithms.size()];
		for(int i = 0; i < classifierAlgorithms.size(); ++i) {
			classifiersStr[i] = classifierAlgorithms.get(i);
		}
		...
		startBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
            	triggerAlgorithm(classifierAlgorithms.get(classifierList.getSelectedIndex()).trim().toLowerCase(),primeAttributeList.getSelectedIndex());
            }
        });
